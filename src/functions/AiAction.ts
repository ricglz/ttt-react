...
function extraValueDiagonal(div: number, pos: GeneralBoardIndex, args: ArgsWithoutDifficulty) {
...
function extraValueColumn(div: number, mod: number, args: ArgsWithoutDifficulty) {
  switch (mod) {
    case 0:
