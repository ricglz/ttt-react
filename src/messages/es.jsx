const es = {
  ...
  "game.medium": "Medio",
  "game.hard": "Difícil",
  "game.placeholder": "Escoge la dificultad (Por defecto fácil)",
  "game.reset": "Rendirse",
  "tutorial.first":
    "Las mecánicas del juego son simples, lo que tienes que hacer es dar un click en cualquiera de las celdas, de cualquier matriz disponible, es decir aquellas que tengan el fondo blanco.",
  "tutorial.second":
    "El objetivo de este juego es tener tres Xs u Os juntas en la misma ya sea en diagonal, columna o fila (Así como lo es en un juego de gato normal).",
  "tutorial.third":
